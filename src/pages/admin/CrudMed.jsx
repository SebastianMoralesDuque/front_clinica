...
function CrudMed() {
    ...
    const handleAssignSchedule = (cedula) => {
        console.log(`Asignar horario al médico con cédula: ${cedula}`);
    };
    ...
    return (
        <div className="p-8">
            ...
            <Link
                to="/createmedico"
                className="mb-4 block text-center text-white bg-blue-500 hover:bg-blue-700 py-1 px-2 rounded w-48"
            >
                Registrar Médico
            </Link>
