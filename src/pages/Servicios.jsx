    ...
    <div className="bg-gray-100 min-h-screen flex items-center justify-center">
      <div className="bg-white p-8 rounded-md shadow-md w-full max-w-2xl">
        ...
        <p className="text-gray-600 text-center">
          En la Clínica XYZ, nos esforzamos por proporcionar una amplia gama de servicios de salud para atender tus necesidades. Nuestro equipo de profesionales altamente capacitados se dedica a garantizar tu bienestar y comodidad.
        </p>
        <div className="mt-8">
